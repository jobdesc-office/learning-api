...
class CustomFieldController extends Controller
{
    ...
    public function datatablesschedulebp($id, Request $req, CustomFieldService $CustomFieldService)
    {
        $search = trim(strtolower($req->get('search[value]')));
        $order = $req->get('order[0][column]');
        $orderby = $req->get('order[0][dir]');
        ...
        $query = $CustomFieldService->datatablesschedulebp($id, $order, $orderby, $search);
