...
$router->group(['middleware' => 'auth'], function () use ($router) {
    ...
    $router->group(['namespace' => 'Masters'], function () use ($router) {
        ...
        $router->group(['prefix' => 'types'], function () use ($router) {
            $router->get('by-codemaster', 'TypesController@byCodeMaster');
            $router->get('by-code', 'TypesController@byCode');
            $router->get('by-code-add', 'TypesController@byCodeAdd');
        ...
        $router->group(['prefix' => 'stbptype'], function () use ($router) {
            $router->get('by-code-add', 'StbptypeController@byCodeAdd');
            $router->get('by-code', 'StbptypeController@byCode');
            $router->get('bySeq', 'StbptypeController@bySeq');
