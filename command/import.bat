...
@REM psql -c "\copy msmenu FROM 'permission/menu.csv' delimiter ',' csv header;" "host=10.21.1.30 port=5432 dbname=ventes user=postgres password=P@ssw0rd"
@REM psql -c "\copy msfeature FROM 'permission/feature.csv' delimiter ',' csv header;" "host=10.21.1.30 port=5432 dbname=ventes user=postgres password=P@ssw0rd"
@REM psql -c "\copy mspermission FROM 'permission/permission.csv' delimiter ',' csv header;" "host=10.21.1.30 port=5432 dbname=ventes user=postgres password=P@ssw0rd"
...
@REM psql -c "\copy dspbyowner FROM 'dsp/dspbyowner.csv' delimiter ',' csv header;" "host=10.21.1.30 port=5432 dbname=ventes user=postgres password=P@ssw0rd"
@REM psql -c "\copy dspbystage FROM 'dsp/dspbystage.csv' delimiter ',' csv header;" "host=10.21.1.30 port=5432 dbname=ventes user=postgres password=P@ssw0rd"
@REM psql -c "\copy dspbystatus FROM 'dsp/dspbystatus.csv' delimiter ',' csv header;" "host=10.21.1.30 port=5432 dbname=ventes user=postgres password=P@ssw0rd"